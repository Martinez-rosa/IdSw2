...
public class Aspiradora {
    ...
    public void limpiar(Mundo mundo) {
        ...
        if (celdaActual instanceof CeldaSucia) {
            ...
            int nivelSuciedadAnterior = celdaSucia.getNivelSuciedad();
            
            boolean limpiado = celdaSucia.limpiar();
            basuraRecogida += 1;
            ...
            System.out.printf("Limpiado celda [%d,%d]. Nivel anterior: %d, Nivel actual: %s%n", 
                               posicion.getFila(), posicion.getColumna(), nivelSuciedadAnterior,
                               limpiado ? "limpio" : celdaSucia.getNivelSuciedad());
        }
    }
}